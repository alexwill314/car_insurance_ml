...
def generate_comparison_table(glm_mse: float, glm_r2: float, rf_mse: float, rf_r2: float) -> str:
    """
    ...
    markdown_table = (
        ...
        "| :--- | :---: | :---: |\n"
        f"| Poisson GLM (Baseline) | {glm_mse:.6f} | {glm_r2:.6f} |\n"
        f"| Random Forest (ML) | {rf_mse:.6f} | {rf_r2:.6f} |\n"
    )
...
def main():
    ...
    glm_mse, glm_r2 = evaluate_predictions(glm_y_test, glm_y_pred)

    print("Training Random Forest model...")
    _, rf_y_test, rf_y_pred = train_random_forest()
    rf_mse, rf_r2 = evaluate_predictions(rf_y_test, rf_y_pred)
    ...
    comparison_table = generate_comparison_table(glm_mse, glm_r2, rf_mse, rf_r2)
